...
def build_mlp(output_size, n_layers, size, activation=tf.tanh, output_activation=None):
    """
    ...
    model = keras.Sequential([
        *[keras.layers.Dense(size, activation=activation) for i_layer in range(n_layers)],
